      ...
      <div className="bg-white sm:rounded-lg sm:shadow">
        <div className="px-4 py-5 sm:px-6">
          <div className="flex space-x-3">
            <div className="flex-shrink-0 rounded-full p-1  border-gray-300 border-3 hover:border-indigo-500 transation duration-300">
              <img
        ...
        <div className="px-4 pb-5 sm:p-6 sm:pt-0 bg-gradient-to-r from-gray-100 via-gray-50 to-gray-100 rounded-lg">
          <p >
            {content}
          </p>
        </div>
...
function CardButton() {
  return (
    <div className="flex flex-shrink-0 self-center hover:rotate-360">
      <div as="div" className="relative inline-block text-left">
        <div>
          <div className="-m-2 flex items-center rounded-full p-2 text-gray-400 hover:text-gray-600 hover:rotate-90 transition duration-300">
